...
computer3 = Computer.create(operating_system: "Windows 7", 
            ...
            case_size: "Mini-Tower", user: milly)        
...
order3 =  Order.create(order_date: DateTime.new(2020, 03, 15, 18, 00, 0), shipping_type: "Express", shipping_address: "2200 2nd Ave", user: milly, computer: computer3)